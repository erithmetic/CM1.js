...
// If you don't want to mess around with prototypes, CM1.model gives you an object
// that you can define and run calculations on at a later time:
// 
//     var CM1 = require('cm1');
...
// You can also turn any object into an impact calculating machine. For example, let's
// say we have an object representing a rental car:
// 
// 
...
// 
// Now we want to figure out how much CO2 it emits. CM1.js will add impact calculation
// powers to your prototype. Before instantiating a RentlCar, use `CM1.extend()` to tell
...
// `CM1.extend()`, A new function called `getImpacts()` will be added to your class.
// 
//     var RentalCar = function() {};
//     
...
// 
// CM1 is free for non-commercial use and available for commercial use. Commercial
